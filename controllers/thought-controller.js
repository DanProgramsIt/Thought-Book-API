...
const thoughtController = {
  ...
  addReaction(req, res) {
    Thought.findOneAndUpdate(
      ...
      .then((thoughtData) => {
        ...
        res.json({
          message: "Your reaction was added to this thought.",
          thoughtData,
        });
      })
      .catch((err) => res.status(400).json(err));
  ...
  // DELETE a reaction froma Thought
  removeOneReaction(req, res) {
    Thought.findOneAndUpdate(
      ...
      .then((thoughtData) => {
        ...
        res.json({
          message: "Your reaction was removed from the thought.",
          thoughtData,
        });
      })
      .catch((err) => res.status(400).json(err));
  ...
  // DELETE all reactions from a Thought
  removeAllReaction(req, res) {
    Thought.findOneAndUpdate(
      ...
      .then((thoughtData) => {
        ...
        res.json({
          message: "All reactions removed from this thought.",
          thoughtData,
        });
      })
      .catch((err) => res.status(400).json(err));
